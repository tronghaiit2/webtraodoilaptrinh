    ...
    <div class = "main1">
        <?php 
            ...
            if(!$conn){
                ...
                $artical;
                if($status == 0){
                    $sql = "SELECT COUNT(articles.id) AS total FROM articles WHERE articles.status = 1";
                    $result = mysqli_query($conn, $sql, null);
                    $row =  mysqli_fetch_assoc($result);
                    $total_rows = $row["total"];
                    $total_pages = ceil($total_rows / $no_per_page);
                    
                    $sql = "SELECT * FROM articles WHERE articles.status = 1 ORDER BY articles.publish_date DESC limit $start,$no_per_page";
                    $artical = mysqli_query($conn, $sql, null);
                   
                }
                else if($status == 1){
                    $sql = "SELECT COUNT(articles.id) AS total FROM articles WHERE articles.status = 1 AND articles.vote = 0";
                    $result = mysqli_query($conn, $sql, null);
                    $row =  mysqli_fetch_assoc($result);
                    $total_rows = $row["total"];
                    $total_pages = ceil($total_rows / $no_per_page);
                    
                    $sql = "SELECT * FROM articles WHERE articles.status = 1 AND articles.vote = 0 ORDER BY articles.publish_date DESC limit $start,$no_per_page";
                    $artical = mysqli_query($conn, $sql, null);
                }
                else if($status == 2){
                    $sql = "SELECT COUNT(articles.id) AS total FROM articles 
WHERE articles.status = 1 AND articles.id not in (SELECT comments.id FROM comments)";
                    $result = mysqli_query($conn, $sql, null);
                    $row =  mysqli_fetch_assoc($result);
                    $total_rows = $row["total"];
                    $total_pages = ceil($total_rows / $no_per_page);
                    
                    $sql = "SELECT * FROM articles WHERE articles.status = 1 AND articles.id not in (SELECT comments.id FROM comments)
ORDER BY articles.publish_date DESC limit $start,$no_per_page";
        ...
        ?>
            ...
            <div class="Link">
                <div class="link1">
                    <div id="home" style="background-color: #FFD7D8;" onclick="Home()">
                        <p>Home</p>
                        <div id="b1" class="bb" style="background-color:pink"></div>
                    </div>
            ...
            <div class="content">
                ...
                <div class="title_b_ask">
                    <p>The questions have been moderated</p>
                ...
                <div class="linkP" style="margin-left:15px; margin-top:5px; display:flex">
                    <?php 
                    echo "<a style=\"margin-left:5px; margin-right:5px; display:block; position: relative; z-index:7;\"  href='home.php?page=1'>"."First"."</a>";
                    if($page <= 1){
                            echo "<a style=\"margin-left:5px; margin-right:5px; display:block; position: relative; z-index:7;\"  href=#>Prev</a>";
                    }
                    else{
                        echo "<a style=\"margin-left:5px; margin-right:5px; display:block; position: relative; z-index:7;\"  href='home.php?page=".($page-1)."'>"."Prev"."</a>";
                    }
                    
                    if($total_pages <= 4){    
                        for($i=1; $i<=$total_pages; $i++){
                            echo "<a style=\"margin-left:5px; margin-right:5px; display:block; position: relative; z-index:7;\"  href='home.php?page=".$i."'>".$i."</a>";
                        }
                        
                    }
                    else{
                        echo "<a style=\"margin-left:5px; margin-right:5px; display:block; position: relative; z-index:7;\"  href='home.php?page=1'>1</a>";
                        echo "<a style=\"margin-left:5px; margin-right:5px; display:block; position: relative; z-index:7;\"  href='home.php?page=2'>2</a>";
                        echo "...";
                        echo "<a style=\"margin-left:5px; margin-right:5px; display:block; position: relative; z-index:7;\"  href='home.php?page=".($total_pages-1)."'>".($total_pages-1)."</a>";
                        echo "<a style=\"margin-left:5px; margin-right:5px; display:block; position: relative; z-index:7;\"  href='home.php?page=".$total_pages."'>".$total_pages."</a>";
                    }
                    if($page >= $total_pages){
                            echo "<a style=\"margin-left:5px; margin-right:5px; display:block; position: relative; z-index:7;\"  href=#>Next</a>";
                    }
                    else{
                        echo "<a style=\"margin-left:5px; margin-right:5px; display:block; position: relative; z-index:7;\"  href='home.php?page=".($page+1)."'>"."Next"."</a>";
                    }
                    
                    echo "<a style=\"margin-left:5px; margin-right:5px; display:block; position: relative; z-index:7;\"  href='home.php?page=".$total_pages."'>"."Last"."</a>";
                    ?>
                </div>
                            <?php
                        }
                ...
                <div class="linkP" style="margin-left:15px; margin-top:5px; display:flex">
                    <?php 
                    echo "<a style=\"margin-left:5px; margin-right:5px; display:block; position: relative; z-index:7;\"  href='home.php?page=1&status=uv'>"."First"."</a>";
                    if($page <= 1){
                            echo "<a style=\"margin-left:5px; margin-right:5px; display:block; position: relative; z-index:7;\"  href=#>Prev</a>";
                    }
                    else{
                        echo "<a style=\"margin-left:5px; margin-right:5px; display:block; position: relative; z-index:7;\"  href='home.php?page=".($page-1)."&status=uv'>"."Prev"."</a>";
                    }
                    
                    if($total_pages <= 4){    
                        for($i=1; $i<=$total_pages; $i++){
                            echo "<a style=\"margin-left:5px; margin-right:5px; display:block; position: relative; z-index:7;\"  href='home.php?page=".$i."&status=uv'>".$i."</a>";
                        }
                        
                    }
                    else{
                        echo "<a style=\"margin-left:5px; margin-right:5px; display:block; position: relative; z-index:7;\"  href='home.php?page=1&status=uv'>1</a>";
                        echo "<a style=\"margin-left:5px; margin-right:5px; display:block; position: relative; z-index:7;\"  href='home.php?page=2&status=uv'>2</a>";
                        echo "...";
                        echo "<a style=\"margin-left:5px; margin-right:5px; display:block; position: relative; z-index:7;\"  href='home.php?page=".($total_pages-1)."&status=uv'>".($total_pages-1)."</a>";
                        echo "<a style=\"margin-left:5px; margin-right:5px; display:block; position: relative; z-index:7;\"  href='home.php?page=".$total_pages."&status=uv'>".$total_pages."</a>";
                    }
                    if($page >= $total_pages){
                            echo "<a style=\"margin-left:5px; margin-right:5px; display:block; position: relative; z-index:7;\"  href=#>Next</a>";
                    }
                    else{
                        echo "<a style=\"margin-left:5px; margin-right:5px; display:block; position: relative; z-index:7;\"  href='home.php?page=".($page+1)."&status=uv'>"."Next"."</a>";
                    }
                    
                    echo "<a style=\"margin-left:5px; margin-right:5px; display:block; position: relative; z-index:7;\"  href='home.php?page=".$total_pages."&status=uv'>"."Last"."</a>";
                    ?>
                </div>
                            <?php
                        }
                ...
                <div class="linkP" style="margin-left:15px; margin-top:5px; display:flex">
                    <?php 
                    echo "<a style=\"margin-left:5px; margin-right:5px; display:block; position: relative; z-index:7;\"  href='home.php?page=1&status=ucmt'>"."First"."</a>";
                    if($page <= 1){
                            echo "<a style=\"margin-left:5px; margin-right:5px; display:block; position: relative; z-index:7;\"  href=#>Prev</a>";
                    }
                    else{
                        echo "<a style=\"margin-left:5px; margin-right:5px; display:block; position: relative; z-index:7;\"  href='home.php?page=".($page-1)."&status=ucmt'>"."Prev"."</a>";
                    }
                    
                    if($total_pages <= 4){    
                        for($i=1; $i<=$total_pages; $i++){
                            echo "<a style=\"margin-left:5px; margin-right:5px; display:block; position: relative; z-index:7;\"  href='home.php?page=".$i."&status=ucmt'>".$i."</a>";
                        }
                        
                    }
                    else{
                        echo "<a style=\"margin-left:5px; margin-right:5px; display:block; position: relative; z-index:7;\"  href='home.php?page=1&status=ucmt'>1</a>";
                        echo "<a style=\"margin-left:5px; margin-right:5px; display:block; position: relative; z-index:7;\"  href='home.php?page=2&status=ucmt'>2</a>";
                        echo "...";
                        echo "<a style=\"margin-left:5px; margin-right:5px; display:block; position: relative; z-index:7;\"  href='home.php?page=".($total_pages-1)."&status=ucmt'>".($total_pages-1)."</a>";
                        echo "<a style=\"margin-left:5px; margin-right:5px; display:block; position: relative; z-index:7;\"  href='home.php?page=".$total_pages."&status=ucmt'>".$total_pages."</a>";
                    }
                    if($page >= $total_pages){
                            echo "<a style=\"margin-left:5px; margin-right:5px; display:block; position: relative; z-index:7;\"  href=#>Next</a>";
                    }
                    else{
                        echo "<a style=\"margin-left:5px; margin-right:5px; display:block; position: relative; z-index:7;\"  href='home.php?page=".($page+1)."&status=ucmt'>"."Next"."</a>";
                    }
                    
                    echo "<a style=\"margin-left:5px; margin-right:5px; display:block; position: relative; z-index:7;\"  href='home.php?page=".$total_pages."&status=ucmt'>"."Last"."</a>";
                    ?>
                </div>
                            <?php
                        }
